    ...
    <div className="fixed inset-0 pointer-events-none z-[9999] hidden lg:block">
      ...
      <motion.div
        ...
        style={{
          ...
          translateY: '-50%',
          boxShadow: hovered 
            ? '0 0 16px rgba(212, 175, 55, 0.45), inset 0 0 8px rgba(212, 175, 55, 0.25)' 
            : '0 0 6px rgba(212, 175, 55, 0.1)',
          borderColor: hovered ? 'rgba(212, 175, 55, 0.85)' : 'rgba(212, 175, 55, 0.45)',
        }}
        animate={{
      ...
      {/* 2. Glowing Amber Core */}
      <motion.div
        className="fixed w-2 h-2 bg-gradient-to-br from-amber-400 to-yellow-600 rounded-full pointer-events-none"
        style={{
          x: innerX,
          y: innerY,
          translateX: '-50%',
