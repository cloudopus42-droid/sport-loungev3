...
const ICONS: Record<string, IconConfig> = {
  ...
  apple: {
    paths: [
      'M12 3c-2 0-3.5.8-4.5 2.5C6.5 7.5 7 11 9 13c1.5 1.5 2.5 2.5 3 2.5s1.5-1 3-2.5c2-2 2.5-5.5 1.5-7.5C15.5 3.8 14 3 12 3z',
      'M12 3c0-2 2-3.5 4-3',
    ],
  },
  mango: {
    paths: [
      'M12 4c-3.5 0-6.5 2.5-7 7-.5 4.5 2 7.5 5 8.5 1.5.5 3 .2 4-1 1-1.5 1.5-3.5 1-5.5-.5-2-2-3.5-3-4 1-.5 2.5-.5 3.5 0s2 1.5 2 3-1 3-2.5 3.5',
    ],
  },
  peach: {
    paths: [
      'M12 5c-3 0-5.5 2-6.5 5.5-1 3.5.5 6.5 3 8 1.5 1 3 1 4.5 0 2.5-1.5 4-4.5 3-8C15 7 12 5 12 5z',
      'M12 5c0-2.5 1.5-4 3-4.5',
    ],
  },
  citrus: {
    paths: [
  ...
  strawberry: {
    paths: [
      'M12 4c-4 0-6.5 2.5-7 6-.5 3.5 1 6.5 4 8 1 .5 2.5 1 3.5 1s2.5-.5 3.5-1c3-1.5 4.5-4.5 4-8-.5-3.5-3-6-8-6z',
      'M12 4c0-2 1.5-3.5 3-3.5s2.5 1 2 2.5',
      'M9.5 9h.01',
      'M12 8h.01',
      'M14.5 9h.01',
      'M11 12h.01',
