...
const ZONES_LIST: ZonePlate[] = [
  ...
  { 
    ...
    color: '#fbbf24',
    icon: <Gamepad2 className="w-5 h-5 text-[#fbbf24]" /> 
  },
  { 
    id: 'pro', 
    label: 'PRO 600Hz', 
            ...
            return (
              <motion.button
                ...
                className={`absolute z-20 flex flex-col items-center justify-center rounded-xl border text-[9px] font-bold transition-all transform -translate-x-1/2 -translate-y-1/2 shadow-lg ${
                  booked
                    ...
                    : selected
                    ? 'bg-[#2a1d00] border-[#EAB308] text-[#EAB308] shadow-[0_0_20px_rgba(234,179,8,0.3)] z-30 scale-105'
              ...
              >
                ...
                <div className="w-full h-full flex flex-col items-center justify-center px-1 overflow-hidden relative">
                  ...
                  {/* Selected checkmark */}
                  {selected && (
                    <div className="absolute top-1 right-1 w-2.5 h-2.5 rounded-full bg-[#EAB308] flex items-center justify-center text-black">
