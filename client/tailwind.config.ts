  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'gold-glow': '0 4px 20px rgba(176,141,87,0.2), 0 0 40px rgba(176,141,87,0.08)',
        'gold-glow-sm': '0 0 12px rgba(176,141,87,0.1)',
        'gold-glow-lg': '0 4px 32px rgba(176,141,87,0.25), 0 0 60px rgba(176,141,87,0.1)',
