...
router.get('/achievements', auth, asyncHandler(async (req: Request, res: Response) => {
  const userId = req.user!.id;
...
router.get('/loyalty', auth, asyncHandler(async (req: Request, res: Response) => {
  const userId = req.user!.id;
...
router.get('/favorites', auth, asyncHandler(async (req: Request, res: Response) => {
  const userId = req.user!.id;
...
router.post('/favorite-table', auth, asyncHandler(async (req: Request, res: Response) => {
  const userId = req.user!.id;
...
router.post('/favorite-flavor', auth, asyncHandler(async (req: Request, res: Response) => {
  const userId = req.user!.id;
...
router.post('/reviews', auth, asyncHandler(async (req: Request, res: Response) => {
  const userId = req.user!.id;
