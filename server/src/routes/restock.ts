...
router.get('/requests', auth, isAdmin, asyncHandler(async (_req: Request, res: Response) => {
...
router.post('/requests', auth, asyncHandler(async (req: Request, res: Response) => {
...
router.put('/requests/:id', auth, isAdmin, asyncHandler(async (req: Request, res: Response) => {
...
router.post('/check', auth, asyncHandler(async (_req: Request, res: Response) => {
  const { data, error } = await supabase
    .from('mixes')
